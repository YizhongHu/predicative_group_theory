...
| :---        |    :----:   |          ---: |
| Abelian      | `abelian`       | An abelian group is a commutative group, i.e. g₁ * g₂ = g₂ * g₁ for all g₂, g₁. (Ex: Integers mod 5, +) |
| Cyclic   | `cyclic`        | A cyclic group is a group that can be generated by one element. (Ex: Integers mod 5, +)  |
| Order   | `order`        | The order of a group *G* (denoted *\|G\|*) is the number of elements in the group's set (Ex: \|Integers mod 5\| = 5)  |
